...
const DoctorCard = ({ doctor, onBookAppointment }: { doctor: Doctor, onBookAppointment: (doctor: Doctor) => void }) => {
  return (
    <div className="group relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden hover:-translate-y-1">
      ...
      <div className="relative z-10 p-6 flex-grow">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <p className="text-sm font-medium text-gray-900">{doctor.languages?.join(", ") || "Hindi, English"}</p>
          </div>
        </div>

        {/* Consultation Fee */}
        <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-xl p-4 mb-6 border border-emerald-100">
